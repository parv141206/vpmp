...
export default function Home() {
  ...
  const [image1, setImage1] = useState("/assets/images/shreya.jpg");
  const [image2, setImage2] = useState("/assets/images/rashesh.jpg");
  ...
  return (
    <>
      <Carousel />
      <div className="relative md:min-h-[80vh] min-h-screen flex items-center justify-center">
        <div>
          <Image
          ...
          {/* <div
            ref={image1Ref}
            className="absolute md:right-36 md:left-auto md:rotate-[25deg] -right-3 md:top-12 scale-[0.45] md:scale-90 -top-0 rotate-[-25deg] w-fit"
          >
            <AlumniCard
          ...
          <div
            ref={image2Ref}
            className="absolute md:left-36 -left-3 md:right-auto md:rotate-[-25deg] scale-[0.55] md:scale-[0.8] md:top-12 -top-12 rotate-[15deg] w-fit"
          >
            <AlumniCard
